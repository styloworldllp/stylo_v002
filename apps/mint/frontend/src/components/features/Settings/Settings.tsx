    ...
    return <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
            <DialogHeader>
                ...
                <DialogDescription>{_("Configure settings for Stylo Reco.")}</DialogDescription>
            </DialogHeader>
            <div className='flex flex-col gap-4 w-full py-4'>
                ...
                <DataField
                    ...
                    formDescription={_("For example, if set to 4, Stylo Reco will try to find matching transactions in other banks 4 days before and after the transaction date. This is because transactions can clear on different days on different bank accounts.")}
                />
