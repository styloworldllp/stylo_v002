        ...
        <div className="p-4 flex flex-col gap-4">
            <div ref={ref} className="flex flex-col gap-4">
                <div className="flex justify-between">
                    <H1 className="text-base font-medium flex items-center gap-3"><img src="/assets/stylo_core/images/stylo-logo-light.png" alt="Stylo" className="h-10" />{_("Bank Reconciliation")}</H1>
