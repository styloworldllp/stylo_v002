...
export const services: EmailService[] = [
  ...
  },
  {
    name: "Stylo Mail",
    icon: LogoFrappeMail,
    info: `Setting up Stylo Mail requires you to have an API key and API Secret of your email account. Read more `,
