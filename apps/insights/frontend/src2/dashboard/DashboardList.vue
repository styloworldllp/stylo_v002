...
import { SearchIcon, Sparkles } from 'lucide-vue-next'
import { computed, ref, watchEffect } from 'vue'
import { useRouter } from 'vue-router'
import useDashboardStore, { DashboardListItem } from './dashboards'
import DashboardCard from './DashboardCard.vue'
import BrAInDashboardDialog from './BrAInDashboardDialog.vue'
...
watchEffect(() => {
	document.title = 'Dashboards | Stylo Insights'
})
</script>
...
<template>
	<header class="flex h-12 items-center justify-between border-b py-2.5 pl-5 pr-2">
		...
		<div class="flex items-center gap-2">
			<Button variant="subtle" @click="showBrAInDialog = true" class="gap-1.5">
				<template #prefix>
	...
	<BrAInDashboardDialog v-model="showBrAInDialog" />
</template>
