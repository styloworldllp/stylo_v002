	...
	<div>
		<Dropdown :options="userDropdownOptions">
			<template v-slot="{ open }">
				...
				>
					<img
						:src="'/assets/stylo_core/images/stylo-insights-logo.png'"
						alt="Stylo Insights"
					...
					<div
						...
						"
					>
						<div class="text-base font-medium leading-none text-gray-900">Stylo Insights</div>
...
const userDropdownOptions = ref([
	{
		...
		icon: h(HelpCircle),
		onClick: () => window.open('https://docs.styloworld.io/insights', '_blank'),
	},
	{
		label: __('Support'),
		icon: h(MessageCircle),
		onClick: () => window.open('mailto:hello@styloworld.io', '_blank'),
	},
	{
		label: __('Log out'),
		icon: h(LogOut),
