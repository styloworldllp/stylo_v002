	...
	>
		<div class="flex flex-grow flex-col overflow-y-auto p-2.5">
			<div class="rg:flex hidden flex-shrink-0 items-end text-sm text-gray-600">
				<img :src="'/assets/stylo_core/images/stylo-insights-logo.png'" class="h-7" />
			</div>
			<router-link to="/" class="rg:hidden flex cursor-pointer">
				<img :src="'/assets/stylo_core/images/stylo-insights-logo.png'" class="rounded" />
			</router-link>
					...
					:options="[
						{
							label: 'Documentation',
							icon: 'help-circle',
							onClick: () => open('https://docs.styloworld.io/insights'),
						},
						{
							label: 'Support',
							icon: 'message-circle',
							onClick: () => open('mailto:hello@styloworld.io'),
						},
						{
							label: 'Help',
							icon: 'life-buoy',
