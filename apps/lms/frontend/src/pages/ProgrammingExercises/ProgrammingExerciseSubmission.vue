...
const loadFalcon = () => {
	...
	if (!falconURL.value) {
		falconError.value = __('Live code execution is not configured. Set "Livecode URL" in LMS Settings to enable this feature.')
	...
	return new Promise((resolve, reject) => {
		...
		script.onerror = () => {
			falconError.value = __('Could not connect to the live code execution service. Check the "Livecode URL" in LMS Settings.')
			reject()
		}
